...
{
    [JsiiInterfaceProxy(typeof(IEventRuleTargetProps), "@aws-cdk/aws-events.EventRuleTargetProps")]
    internal class EventRuleTargetPropsProxy : DeputyBase, IEventRuleTargetProps
    {
        private EventRuleTargetPropsProxy(ByRefValue reference): base(reference)
        {
        }
