...
namespace Amazon.CDK.AWS.CodeCommitCodePipeline
{
    /// <summary>CodePipeline Source that is provided by an AWS CodeCommit repository.</summary>
    [JsiiClass(typeof(PipelineSource), "@aws-cdk/aws-codecommit-codepipeline.PipelineSource", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/aws-codepipeline.Stage\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"props\",\"type\":{\"fqn\":\"@aws-cdk/aws-codecommit-codepipeline.PipelineSourceProps\"}}]")]
