...
{
    /// <summary>Construction properties of the {@link PipelineInvokeAction Lambda invoke CodePipeline Action}.</summary>
    [JsiiInterfaceProxy(typeof(IPipelineInvokeActionProps), "@aws-cdk/aws-lambda-codepipeline.PipelineInvokeActionProps")]
    internal class PipelineInvokeActionPropsProxy : DeputyBase, IPipelineInvokeActionProps
    {
        private PipelineInvokeActionPropsProxy(ByRefValue reference): base(reference)
        {
        }
