...
namespace Amazon.CDK.AWS.CodeBuildCodePipeline
{
    /// <summary>CodePipeline build Action that uses AWS CodeBuild.</summary>
    [JsiiClass(typeof(PipelineBuildAction), "@aws-cdk/aws-codebuild-codepipeline.PipelineBuildAction", "[{\"name\":\"parent\",\"type\":{\"fqn\":\"@aws-cdk/aws-codepipeline.Stage\"}},{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"props\",\"type\":{\"fqn\":\"@aws-cdk/aws-codebuild-codepipeline.PipelineBuildActionProps\"}}]")]
